...
import '../future_calls/report_scheduler_call.dart' as _i3;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'ReportSchedulerCallInvokeFutureCall':
          ReportSchedulerCallInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final reportSchedulerCall = _ReportSchedulerCallFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _ReportSchedulerCallFutureCallDispatcher {
  _ReportSchedulerCallFutureCallDispatcher(this._invokeFutureCall);
...
class ReportSchedulerCallInvokeFutureCall
  ...
  _i2.Future<void> invoke(
    ...
    await _i3.ReportSchedulerCall().invoke(
      session,
      object,
    );
  }
